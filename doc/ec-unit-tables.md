...
> **Draft.** Proposed in
> [#25](https://github.com/mdhender/ecv7/issues/25#issuecomment-5054182309): one
> row per valid `(unit_code, tech_level)` pair. This is one option for
> satisfying the domain invariants, not a required persistence design.
